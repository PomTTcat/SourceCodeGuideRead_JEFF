...
@property (nonatomic, strong, readonly) NSString *typeEncoding; ///< Ivar's type encoding   ivar编码
@property (nonatomic, assign, readonly) YYEncodingType type; ///< Ivar's type               ivar具体类型（yy翻译了该编码）
...
//objc_property_attribute_t ->getter    setter  type
@end
